...
from QtWidgets import QAction, QMenu, QWidget, QMessageBox, QSizePolicy, QLabel, QComboBox, QDialog, QPushButton, QVBoxLayout, QHBoxLayout, QLineEdit, QCompleter, QGroupBox, QToolButton, QRadioButton
from QtGui import QIcon, QPainter, QColor, QFont, QBrush, QPen, QImage, QPixmap, qRgb
...
from autonomous_vehicle.srv import ControlStatus
...
class ServiceButtonGeneralWidget(QWidget):
    ...
    def buttonCallbackImpl(self, service_name):
        ...
        # TODO(youngbo) : Currently, i want to use ControlStatus.srv
        srv = rospy.ServiceProxy(service_name, ControlStatus)
        try:
            srv(True)
