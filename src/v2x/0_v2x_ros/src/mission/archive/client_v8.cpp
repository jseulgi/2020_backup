...
public:
	...
	void initParams(void) {
		...
		if (yaml_mission_list.size() == 0){
			...
			yaml_mission_list.emplace_back(14);
		}
		...
		if ((is_v2x_on_ == true) && (is_connect_ != -1)){
			switch (mission_state){
				...
				case choosing_mission:{
					...
					// option 2: 계산해서 미션 고르기
	////..............................................................
	// more work to do... "key"관련해서도 해야함, 또 done_mission_list를 언제 추가할지도 띵킹해야돼
					// std::vector<int> mission_in_order = PrioritizeMission();
					// selected_mission = mission_in_order[key];
	////..............................................................
