...
//		12. Mission들 중에서 어떤 것들이 AVAILABLE한지 알려주는 std::vector만들기
//
// 		13. thread로 implement해보기
//
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
private:
	...
	std::vector<bool> mission_available_;
...
public:	
	...
	void update_mission_bufs(const std::string &payload){
		...
		for (int i=0; i<(int)payload[0]; i++) {
			...
			mission_available_[i+1] = m_status;
		}
